...
" />
        ...
        <Section dot :src2="taDesktop" showImage sectionTitle="Where to begin"
            ...
            contentTwo="There are some obvious UX/UI changes that need to be made, but without knowing exactly what we needed to fix, we decided to create a survey to find out more." />
        ...
        <Section dot showImage :src2="taWhyVisit" sectionTitle="" contentOne="" contentTwo="" />

        <Section dot showImage :src2="taAffinity" sectionTitle="Organizing our data" contentOne="" contentTwo="" />
