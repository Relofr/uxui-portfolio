...
" />
        ...
        <Section showDot :src2="taDesktop" showImage sectionTitle="Where to begin"
            contentOne="At first glance, the site looks properly taken care of"
            contentTwo="There are some obvious UX/UI changes that need to be made, but without knowing exactly what I needed to fix, I decided to create a survey to find out more about our users and their experience" />

        <Section showDot showImage :src2="surveyPie" sectionTitle="Survey Data"
        ...
        <Section showDot showImage isColumn :src2="taWhyVisit" sectionTitle="What brings our customers in?" contentOne=""
            contentTwo="" />

        <Section showDot showImage isColumn :src2="taAffinity" sectionTitle="Organizing our data" contentOne=""
            contentTwo="" />

        <Section showDot showImage isColumn :src2="taUserInsight" sectionTitle="User Insights" contentOne="" />

        <Section showDot showImage :src2="taUserInterviewNotes" sectionTitle="User Interviews"
            contentOne="The ability to purchase tickets and to make a donation to the aviary is confusing and difficult to navigate" contentTwo="This was due to having poor contrast between text and background, not having a grid system in place, and a poor hierarchy of elements" />

        <SectionBreak title="Definition" />

        <Section showDot showImage isColumn :src2="taUserFlow" sectionTitle="Updated User Flow" contentOne="" />
        <Section showDot showImage isColumn :src2="taUserJourney" sectionTitle="User Journey Map" contentOne="Bronson is looking to purchase Admission tickets online" contentTwo="The membership page is scattered and confusing to navigate" contentThree="Bronson is happy to have found the Membership option, so he has access all year and won't have to purchase tickets online anymore" />

        <SectionBreak title="Ideation" />
        <Section showImage isColumn :src2="prioritizationMatrix" sectionTitle="Feature Prioritization Matrix"
...
import taUserJourney from '../assets/images/tracyaviary/ta-userjourney.png';
import taUserFlow from '../assets/images/tracyaviary/ta-userflow.jpg';
import taUserInsight from '../assets/images/tracyaviary/ta-userinsight.jpg';
import taUserInterviewNotes from '../assets/images/tracyaviary/ta-userinterviewnotes.jpg';
import prioritizationMatrix from '../assets/images/tracyaviary/prioritization-matrix.png';

export default {
    setup: () => {
        return { heroTA, taDesktop, surveyPie, taWhyVisit, taAffinity, taUserFlow, prioritizationMatrix, taUserInterviewNotes, taUserInsight, taUserJourney };
    },
